...
x = dt.fit(X_top10, train_data.iloc[:, -1])
...
print("Time taken to run grid search: ", end_time - start_time)

dt = DecisionTreeClassifier(criterion='entropy', max_depth=10, min_samples_split=7)
